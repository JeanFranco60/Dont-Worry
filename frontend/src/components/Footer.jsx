          ...
          <Row>
            ...
            <Col md={4} className="mb-3 mb-md-0">
              ...
              <ul className="list-unstyled">
                <li><a href="#home" className="text-muted">Inicio</a></li>
                <li><a href="#collection" className="text-muted">Colección</a></li>
                <li><a href="#about" className="text-muted">Nosotros</a></li>
                <li><a href="#contact" className="text-muted">Contacto</a></li>
              </ul>
            </Col>
            <Col md={4}>
