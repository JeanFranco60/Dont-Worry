      ...
      <main>
        <section className="py-5 text-center bg-dark text-white">
          <Container>
            ...
            <p className="lead mb-4">Descubre nuestra colección exclusiva de collares para el hombre moderno</p>
            <Button variant="outline-light" size="lg">Ver Colección</Button>
          </Container>
        </section>
              ...
              {[1, 2, 3, 4].map((item) => (
                <Col key={item} md={6} lg={3} className="mb-4">
                  <Card className="h-100 border-0 shadow-sm">
                    <Card.Img variant="top" src={`/placeholder.svg?text=Collar+${item}`} />
                    <Card.Body>
                      <Card.Title>Collar Moderno {item}</Card.Title>
                      <Card.Text className="text-muted">$99.99</Card.Text>
                      <Button variant="outline-dark" className="w-100">Ver Detalles</Button>
                    </Card.Body>
                  </Card>
                </Col>
              ))}
          ...
          <Container>
            <Row className="align-items-center">
              <Col md={6} className="mb-4 mb-md-0">
                <img src="/placeholder.svg?text=About+Us" alt="About Us" className="img-fluid rounded" />
              </Col>
              <Col md={6}>
            ...
            <Row>
              <Col md={4} className="mb-4">
                <Card className="border-0 text-white">
                  <Card.Img src="/placeholder.svg?text=Minimalista" alt="Colección Minimalista" />
              ...
              <Col md={4} className="mb-4">
                <Card className="border-0 text-white">
                  <Card.Img src="/placeholder.svg?text=Urbano" alt="Colección Urbana" />
                  <Card.ImgOverlay className="d-flex flex-column justify-content-end">
              ...
              <Col md={4} className="mb-4">
                <Card className="border-0 text-white">
                  <Card.Img src="/placeholder.svg?text=Elegante" alt="Colección Elegante" />
                  <Card.ImgOverlay className="d-flex flex-column justify-content-end">
        ...
        <section className="py-5 bg-dark text-white" id="newsletter">
          <Container className="text-center">
            ...
            <p className="lead mb-4">Sé el primero en conocer nuestras nuevas colecciones y ofertas exclusivas</p>
            <Row className="justify-content-center">
              <Col md={6}>
                <form className="d-flex">
                  <input type="email" className="form-control me-2" placeholder="Tu correo electrónico" aria-label="Email" />
                  <Button variant="outline-light" type="submit">Suscribirse</Button>
                </form>
              </Col>
            </Row>
          </Container>
